...
export default function Page() {
  ...
  const scrollToTabs = () => {
    document.getElementById('instock-tab-bar')?.scrollIntoView({ behavior: 'smooth', block: 'start' });
  };
  ...
  return (
    <ProjectLayout project={project} scrollTargetId="instock-tab-bar">
      ...
      <div className="flex flex-col gap-10">
        ...
        {/* Tab bar */}
        <div id="instock-tab-bar" className="flex flex-wrap gap-0 border-b border-gray-200 dark:border-white/10 w-fit">
          {tabs.map((tab, i) => (
            <button
              key={i}
